...
def test_clean_path():
    ...
    """
    sample_path = os.path.abspath('test/data/testing_empty_folder')
    sample_path = clean_path(sample_path)
    assert sample_path == os.path.abspath('test/data/testing_empty_folder')
...
def test_path_does_not_contain_jpg_jpeg_nef_cr2_files():
    ...
    """
    sample_photo_roots = traverse_photos_path(os.path.abspath('test/data/testing_empty_folder'))
...
def test_path_contains_files_extensions_jpg_nef_cr2(capsys):
    """Test src//photonomist//__main__ > path_photos
    """
    sample_photo_roots = traverse_photos_path(os.path.abspath('test/data/testing_folder_with_photos'))
    path_photos(sample_photo_roots)
    captured = capsys.readouterr()

    assert os.path.abspath('test/data/testing_folder_with_photos/bla/blanef/blablanef/blablablanef') in captured.out
    assert os.path.abspath('test/data/testing_folder_with_photos/bla/blabla/blablabla') in captured.out
    assert os.path.abspath('test/data/testing_folder_with_photos/bla/blablacr2') in captured.out
...
def test_photo_folder_exist_in_export_path():
    ...
    export_path = os.path.abspath('test/data/testing_empty_folder')
...
def delete_folder_after_test():
    ...
    os.rmdir(os.path.abspath('test/data/testing_empty_folder/1990_07_23_place_reason_people'))
...
def test_create_photo_folder(delete_folder_after_test):
    ...
    assert '1990_07_23_place_reason_people' in os.listdir(export_path)

@pytest.fixture()
def move_photo_del_folder():
    move_photo_del_folder = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_reason_people/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
...
def move_photo_del_folder_month_keyword():
    move_photo_del_folder_month_keyword = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder_month_keyword
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_place_reason_people/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
...
def move_photo_del_folder_year_keyword():
    move_photo_del_folder_year_keyword = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder_year_keyword
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_place_reason_people/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
...
def move_photo_del_folder_place():
    move_photo_del_folder_place = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder_place
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder'))
...
def test_transfer_photo_to_another_folder_place_name_convention(move_photo_del_folder_place):
    ...
    assert "DSC_0262.NEF" in os.listdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place'))

@pytest.fixture()
def move_photo_del_folder_place_reason():
    move_photo_del_folder_place_reason = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder_place_reason
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_reason/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_reason'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder'))
...
def test_transfer_photo_to_another_folder_place_reason_name_convention(move_photo_del_folder_place_reason):
    ...
    assert "DSC_0262.NEF" in os.listdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_reason'))

@pytest.fixture()
def move_photo_del_folder_place_people():
    move_photo_del_folder_place_people = os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF')
    yield move_photo_del_folder_place_people
    shutil.move(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_people/DSC_0262.NEF'), os.path.abspath('test/data/testing_folder_with_photos/bla/DSC_0262.NEF'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_people'))
    os.rmdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder'))
...
def test_transfer_photo_to_another_folder_place_people_name_convention(move_photo_del_folder_place_people):
    ...
    assert "DSC_0262.NEF" in os.listdir(os.path.abspath('test/data/testing_folder_with_photos/move_folder/2019_12_14_place_people'))

def test_if_export_and_input_paths_point_to_the_same_disk():
    """Test src//photonomist//__main__ > paths_same_disk
    """
    photos_path = os.path.abspath('/a/random/path/to/photos')
    export_path = os.path.abspath('/test/data/testing_folder_with_photos/move_folder')
...
def test_if_export_and_input_paths_do_not_point_to_the_same_disk():
    """Test src//photonomist//__main__ > paths_same_disk
    """
    photos_path = os.path.abspath('G:/DCIM/104D5500')
    export_path = os.path.abspath('test/data/testing_folder_with_photos')
...
def test_input_path_validation_path_items(delete_create_empty_test_file):
    """ Test for src//photonomist//__main__ > input_path_validation
    """
    sample_path = delete_create_empty_test_file
    with pytest.raises(Exception, match="The provided path does not contain any files!"):
